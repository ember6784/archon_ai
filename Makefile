...
# Run linting
lint:
    ruff check mat/ enterprise/ tests/ scripts/
    mypy mat/ enterprise/

# Format code
format:
    ruff check --fix mat/ enterprise/ tests/ scripts/
    black mat/ enterprise/ tests/ scripts/
...
gateway-e2e:
    ...
    python tests/integration/test_end_to_end.py --interactive

# @quant_dev_ai_bot integration
quant-setup:
    @echo "Setting up @quant_dev_ai_bot..."
    python scripts/setup_quant_bot.py

quant-run:
    @echo "Running Archon AI with @quant_dev_ai_bot..."
    python scripts/run_quant_bot.py
...
setup-env:
    ...
    python scripts/setup_from_env.py
